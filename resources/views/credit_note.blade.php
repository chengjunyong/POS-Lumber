...
<div class="modal fade text-left" id="dark" tabindex="-1" role="dialog" aria-labelledby="myModalLabel150" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
	  <div class="modal-content">
	      ...
	      <div class="modal-body" style="font-size:20px">Credit Note Generate Successful</div>
...
<div class="page-title">
  <h3>Invoice</h3>
  <p class="text-subtitle text-muted">Generate Credit Note</p>
</div>
@csrf
		...
		<div class="col-md-12 col-12">
			<div class="card">
				<div class="card-header">
					<h4 style="float:left">Credit Note Form</h4>
					<i id="max" data-feather="maximize" style="height:2rem;float:right" c="0"></i>
				</div>
				<form action="{{route('postCreditNote')}}" method="post">
					<div class="row">
						<h5 style="margin-left: 30px">Credit Note Number - ({{ $credit_note_number }})</h5>

						<input type="text" hidden name="credit_note_number" value="{{ $credit_note_number }}" />
